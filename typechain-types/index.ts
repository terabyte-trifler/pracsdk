...
export type { IRiskScorer } from "./contracts/IRiskScorer";
export { IRiskScorer__factory } from "./factories/contracts/IRiskScorer__factory";
export type { OCCRScorer } from "./contracts/OCCRScorer";
export { OCCRScorer__factory } from "./factories/contracts/OCCRScorer__factory";
